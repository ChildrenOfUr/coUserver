...
{
	Alph(String id, num x, num y, String streetName) : super(id,x,y, streetName)
	{
		states =
			{
...
class AlphFirebog extends Shrine {
	AlphFirebog(String id, num x, num y, String streetName) : super(id, x, y, streetName) {
		states = {
...
class AlphIx extends Shrine {
	AlphIx(String id, num x, num y, String streetName) : super(id, x, y, streetName) {
		states = {
...
class AlphUralia extends Shrine {
	AlphUralia(String id, num x, num y, String streetName) : super(id, x, y, streetName) {
		states = {
