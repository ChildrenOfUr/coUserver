...
{
	Alph(String id, num x, num y, num z, String streetName) : super(id,x,y, z, streetName)
	{
		states =
			{
...
class AlphFirebog extends Shrine {
	AlphFirebog(String id, num x, num y, num z, String streetName) : super(id, x, y, z, streetName) {
		states = {
...
class AlphIx extends Shrine {
	AlphIx(String id, num x, num y, num z, String streetName) : super(id, x, y, z, streetName) {
		states = {
...
class AlphUralia extends Shrine {
	AlphUralia(String id, num x, num y, num z, String streetName) : super(id, x, y, z, streetName) {
		states = {
