...
class Friendly extends Shrine
{
	Friendly(String id, num x, num y, num z, num rotation, bool h_flip, String streetName) : super(id, x, y, z, rotation, h_flip, streetName)
	{
		states =
			{
				"close" : new Spritesheet("close","https://childrenofur.com/assets/entityImages/npc_shrine_friendly__x1_close_png_1354831218.png",906,752,151,188,23,false),
				"open" : new Spritesheet("open","https://childrenofur.com/assets/entityImages/npc_shrine_friendly__x1_open_png_1354831217.png",906,752,151,188,22,false),
				"still" : new Spritesheet("still","https://childrenofur.com/assets/entityImages/npc_shrine_friendly__x1_open_png_1354831217.png",906,752,151,188,1,false)
			};
	 	setState('still');
	 	type = 'Friendly';
