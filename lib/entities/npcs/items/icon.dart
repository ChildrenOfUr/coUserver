...
class Icon extends EntityItem with MetabolicsChange {
	static final Map<String, Spritesheet> SPRITESHEETS = {
		'Alph': new Spritesheet('Alph',
			'http://childrenofur.com/assets/entityImages/icon_alph__x1_1_png_1354836409.png',
			86, 103, 86, 103, 1, true),
		'Cosma': new Spritesheet('Cosma',
			'http://childrenofur.com/assets/entityImages/icon_cosma__x1_1_png_1354836412.png',
			94, 92, 94, 92, 1, true),
		'Friendly': new Spritesheet('Friendly',
			'http://childrenofur.com/assets/entityImages/icon_friendly__x1_1_png_1354836414.png',
			85, 87, 85, 87, 1, true),
		'Grendaline': new Spritesheet('Grendaline',
			'http://childrenofur.com/assets/entityImages/icon_grendaline__x1_1_png_1354836417.png',
			81, 96, 81, 96, 1, true),
		'Humbaba': new Spritesheet('Humbaba',
			'http://childrenofur.com/assets/entityImages/icon_humbaba__x1_1_png_1354836421.png',
			79, 93, 79, 93, 1, true),
		'Lem': new Spritesheet('Lem',
			'http://childrenofur.com/assets/entityImages/icon_lem__x1_1_png_1354836425.png',
			88, 93, 88, 93, 1, true),
		'Mab': new Spritesheet('Mab',
			'http://childrenofur.com/assets/entityImages/icon_mab__x1_1_png_1354836427.png',
			78, 95, 78, 95, 1, true),
		'Pot': new Spritesheet('Pot',
			'http://childrenofur.com/assets/entityImages/icon_pot__x1_1_png_1354836430.png',
			104, 89, 104, 89, 1, true),
		'Spriggan': new Spritesheet('Spriggan',
			'http://childrenofur.com/assets/entityImages/icon_spriggan__x1_1_png_1354836433.png',
			69, 94, 69, 94, 1, true),
		'Tii': new Spritesheet('Tii',
			'http://childrenofur.com/assets/entityImages/icon_tii__x1_1_png_1354836435.png',
			86, 77, 86, 77, 1, true),
		'Zille': new Spritesheet('Zille',
			'http://childrenofur.com/assets/entityImages/icon_zille__x1_1_png_1354836438.png',
			97, 90, 97, 90, 1, true),
	};
