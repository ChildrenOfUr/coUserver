...
class RacingCubimal extends EntityItem {
	static final Map<String, Spritesheet> SPRITESHEETS = {
		'race_batterfly': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_batterfly__x1_race_png_1354836243.png',
			720, 117, 36, 39, 60, true),
		'race_bureaucrat': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_bureaucrat__x1_race_png_1354836246.png',
			720, 81, 36, 27, 60, true),
		'race_butler': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_butler__x1_race_png_1354839843.png',
			720, 78, 36, 26, 60, true),
		'race_butterfly': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_butterfly__x1_race_png_1354836249.png',
			760, 108, 38, 36, 60, true),
		'race_cactus': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_cactus__x1_race_png_1354836252.png',
			720, 78, 36, 26, 60, true),
		'race_chick': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_chick__x1_race_png_1354836255.png',
			720, 96, 36, 32, 60, true),
		'race_crab': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_crab__x1_race_png_1354836258.png',
			760, 93, 38, 31, 60, true),
		'race_craftybot': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_craftybot__x1_race_png_1354839845.png',
			720, 78, 36, 26, 60, true),
		'race_deimaginator': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_deimaginator__x1_race_png_1354836263.png',
			720, 87, 36, 29, 60, true),
		'race_dustbunny': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_dustbunny__x1_race_png_1354836266.png',
			740, 72, 37, 24, 60, true),
		'race_emobear': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_emobear__x1_race_png_1354839825.png',
			780, 84, 39, 28, 60, true),
		'race_factorydefect_chick': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_factorydefect_chick__x1_race_png_1354840105.png',
			780, 132, 52, 33, 59, true),
		'race_firebogstreetspirit': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_firebogstreetspirit__x1_race_png_1354839837.png',
			740, 87, 37, 29, 60, true),
		'race_firefly': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_firefly__x1_race_png_1354836269.png',
			720, 108, 36, 36, 60, true),
		'race_fox': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_fox__x1_race_png_1354839818.png',
			740, 84, 37, 28, 60, true),
		'race_foxranger': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_foxranger__x1_race_png_1354839827.png',
			720, 78, 36, 26, 60, true),
		'race_frog': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_frog__x1_race_png_1354836277.png',
			760, 93, 38, 31, 60, true),
		'race_gardeningtoolsvendor': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_gardeningtoolsvendor__x1_race_png_1354839863.png',
			760, 96, 38, 32, 60, true),
		'race_gnome': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_gnome__x1_race_png_1354839840.png',
			760, 93, 38, 31, 60, true),
		'race_greeterbot': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_greeterbot__x1_race_png_1354836279.png',
			720, 84, 36, 28, 60, true),
		'race_groddlestreetspirit': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_groddlestreetspirit__x1_race_png_1354839830.png',
			780, 99, 39, 33, 60, true),
		'race_gwendolyn': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_gwendolyn__x1_race_png_1354836282.png',
			720, 78, 36, 26, 60, true),
		'race_helga': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_helga__x1_race_png_1354836288.png',
			740, 90, 37, 30, 60, true),
		'race_hellbartender': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_hellbartender__x1_race_png_1354839855.png',
			780, 144, 39, 48, 60, true),
		'race_ilmenskiejones': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_ilmenskiejones__x1_race_png_1354839851.png',
			740, 90, 37, 30, 60, true),
		'race_juju': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_juju__x1_race_png_1354836285.png',
			720, 81, 36, 27, 60, true),
		'race_magicrock': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_magicrock__x1_race_png_1354836290.png',
			720, 72, 36, 24, 60, true),
		'race_maintenancebot': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_maintenancebot__x1_race_png_1354839966.png',
			720, 84, 36, 28, 60, true),
		'race_mealvendor': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_mealvendor__x1_race_png_1354839861.png',
			760, 87, 38, 29, 60, true),
		'race_phantom': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_phantom__x1_race_png_1354839848.png',
			720, 99, 36, 33, 60, true),
		'race_piggy': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_piggy__x1_race_png_1354836293.png',
			740, 84, 37, 28, 60, true),
		'race_rook': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_rook__x1_race_png_1354836296.png',
			800, 87, 40, 29, 60, true),
		'race_rube': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_rube__x1_race_png_1354836298.png',
			760, 78, 38, 26, 60, true),
		'race_scionofpurple': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_scionofpurple__x1_race_png_1354839874.png',
			780, 105, 39, 35, 60, true),
		'race_senorfunpickle': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_senorfunpickle__x1_race_png_1354839878.png',
			860, 99, 43, 33, 60, true),
		'race_sloth': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_sloth__x1_race_png_1354839821.png',
			720, 90, 36, 30, 60, true),
		'race_smuggler': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_smuggler__x1_race_png_1354836301.png',
			740, 78, 37, 26, 60, true),
		'race_snoconevendor': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_snoconevendor__x1_race_png_1354836305.png',
			720, 84, 36, 28, 60, true),
		'race_squid': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_squid__x1_race_png_1354836309.png',
			760, 81, 38, 27, 60, true),
		'race_toolvendor': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_toolvendor__x1_race_png_1354839858.png',
			720, 87, 36, 29, 60, true),
		'race_trisor': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_trisor__x1_race_png_1354839871.png',
			720, 72, 36, 24, 60, true),
		'race_unclefriendly': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_unclefriendly__x1_race_png_1354836312.png',
			740, 93, 37, 31, 60, true),
		'race_uraliastreetspirit': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_uraliastreetspirit__x1_race_png_1354839833.png',
			780, 90, 39, 30, 60, true),
		'race_yeti': new Spritesheet('race',
			'https://childrenofur.com/assets/entityImages/npc_cubimal_yeti__x1_race_png_1354836351.png',
