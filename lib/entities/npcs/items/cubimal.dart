...
class RacingCubimal extends EntityItem {
	...
	RacingCubimal(String id, int x, int y, String streetName) : super(id, x, y, streetName) {
		type = 'Cubimal';
		states = SPRITESHEETS;
		actions = [];
		speed = 0;
...
class RacingCubimal_batterfly extends RacingCubimal {
	RacingCubimal_batterfly(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_bureaucrat extends RacingCubimal {
	RacingCubimal_bureaucrat(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_butler extends RacingCubimal {
	RacingCubimal_butler(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Butler Cubimal';
...
class RacingCubimal_butterfly extends RacingCubimal {
	RacingCubimal_butterfly(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_cactus extends RacingCubimal {
	RacingCubimal_cactus(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Cactus Cubimal';
...
class RacingCubimal_chick extends RacingCubimal {
	RacingCubimal_chick(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Chick Cubimal';
		setState('race_chick');
	}
}
...
class RacingCubimal_crab extends RacingCubimal {
	RacingCubimal_crab(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Crab Cubimal';
		setState('race_crab');
	}
}
...
class RacingCubimal_craftybot extends RacingCubimal {
	RacingCubimal_craftybot(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_deimaginator extends RacingCubimal {
	RacingCubimal_deimaginator(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_dustbunny extends RacingCubimal {
	RacingCubimal_dustbunny(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_emobear extends RacingCubimal {
	RacingCubimal_emobear(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_factorydefect_chick extends RacingCubimal {
	RacingCubimal_factorydefect_chick(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_firebogstreetspirit extends RacingCubimal {
	RacingCubimal_firebogstreetspirit(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_firefly extends RacingCubimal {
	RacingCubimal_firefly(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_fox extends RacingCubimal {
	RacingCubimal_fox(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Fox Cubimal';
		setState('race_fox');
	}
}
...
class RacingCubimal_foxranger extends RacingCubimal {
	RacingCubimal_foxranger(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_frog extends RacingCubimal {
	RacingCubimal_frog(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Frog Cubimal';
		setState('race_frog');
	}
}
...
class RacingCubimal_gardeningtoolsvendor extends RacingCubimal {
	RacingCubimal_gardeningtoolsvendor(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_gnome extends RacingCubimal {
	RacingCubimal_gnome(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Gnome Cubimal';
		setState('race_gnome');
	}
}
...
class RacingCubimal_greeterbot extends RacingCubimal {
	RacingCubimal_greeterbot(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_groddlestreetspirit extends RacingCubimal {
	RacingCubimal_groddlestreetspirit(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_gwendolyn extends RacingCubimal {
	RacingCubimal_gwendolyn(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_helga extends RacingCubimal {
	RacingCubimal_helga(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Helga Cubimal';
		setState('race_helga');
	}
}
...
class RacingCubimal_hellbartender extends RacingCubimal {
	RacingCubimal_hellbartender(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_ilmenskiejones extends RacingCubimal {
	RacingCubimal_ilmenskiejones(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_juju extends RacingCubimal {
	RacingCubimal_juju(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Juju Cubimal';
		setState('race_juju');
	}
}
...
class RacingCubimal_magicrock extends RacingCubimal {
	RacingCubimal_magicrock(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_maintenancebot extends RacingCubimal {
	RacingCubimal_maintenancebot(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_mealvendor extends RacingCubimal {
	RacingCubimal_mealvendor(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_phantom extends RacingCubimal {
	RacingCubimal_phantom(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_piggy extends RacingCubimal {
	RacingCubimal_piggy(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Piggy Cubimal';
		setState('race_piggy');
	}
}
...
class RacingCubimal_rook extends RacingCubimal {
	RacingCubimal_rook(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Rook Cubimal';
		setState('race_rook');
	}
}
...
class RacingCubimal_rube extends RacingCubimal {
	RacingCubimal_rube(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Rube Cubimal';
		setState('race_rube');
	}
}
...
class RacingCubimal_scionofpurple extends RacingCubimal {
	RacingCubimal_scionofpurple(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_senorfunpickle extends RacingCubimal {
	RacingCubimal_senorfunpickle(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_sloth extends RacingCubimal {
	RacingCubimal_sloth(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Sloth Cubimal';
		setState('race_sloth');
	}
}
...
class RacingCubimal_smuggler extends RacingCubimal {
	RacingCubimal_smuggler(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_snoconevendor extends RacingCubimal {
	RacingCubimal_snoconevendor(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_squid extends RacingCubimal {
	RacingCubimal_squid(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Squid Cubimal';
		setState('race_squid');
	}
}
...
class RacingCubimal_toolvendor extends RacingCubimal {
	RacingCubimal_toolvendor(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_trisor extends RacingCubimal {
	RacingCubimal_trisor(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Trisor Cubimal';
...
class RacingCubimal_unclefriendly extends RacingCubimal {
	RacingCubimal_unclefriendly(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_uraliastreetspirit extends RacingCubimal {
	RacingCubimal_uraliastreetspirit(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
...
class RacingCubimal_yeti extends RacingCubimal {
	RacingCubimal_yeti(String id, int x, int y, String streetName) : super (id, x, y, streetName) {
		type = 'Yeti Cubimal';
		setState('race_yeti');
	}
}