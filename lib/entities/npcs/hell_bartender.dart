...
class HellBartender extends NPC {
	HellBartender(String id, num x, num y, num z, String streetName) : super(id, x, y, z, streetName) {
		type = "Hell Bartender";
		actionTime = 0;
		speed = 0;
		actions = [
		...
		states = {
			"idle1": new Spritesheet(
				"idle1",
				"http://childrenofur.com/assets/entityImages/hell_bartender__x1_idle1_png_1354837767.png",
				3416, 1182, 244, 197, 81, true
			),
			"idle2": new Spritesheet(
				"idle2",
				"http://childrenofur.com/assets/entityImages/hell_bartender__x1_idle2_png_1354837775.png",
				3660, 1182, 244, 197, 87, false
			),
			"talk_left": new Spritesheet(
				"talk_left",
				"http://childrenofur.com/assets/entityImages/hell_bartender__x1_talk_left_png_1354837789.png",
				3904, 1379, 244, 197, 110 , false
			),
			"talk_right_out": new Spritesheet(
				"talk_right_out",
				"http://childrenofur.com/assets/entityImages/hell_bartender__x1_talk_right_out_png_1354837783.png",
				976, 394, 244, 197, 7 , false
			),
			"talk_right": new Spritesheet(
				"talk_right",
				"http://childrenofur.com/assets/entityImages/hell_bartender__x1_talk_right_png_1354837781.png",
