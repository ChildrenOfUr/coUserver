...
class PotFirebog extends Shrine
{
	PotFirebog(String id, int x, int y) : super(id,x,y)
	{
		states =
		{
			"close" : new Spritesheet("close","http://c2.glitch.bz/items/2012-12-06/npc_shrine_firebog_pot__x1_close_png_1354832830.png",984, 848, 164, 212, 23, false),
			"open" : new Spritesheet("open","http://c2.glitch.bz/items/2012-12-06/npc_shrine_firebog_pot__x1_open_png_1354832828.png",984, 848, 164, 212, 22, false),
			"still" : new Spritesheet("still","http://c2.glitch.bz/items/2012-12-06/npc_shrine_firebog_pot__x1_open_png_1354832828.png", 984, 848, 164, 212, 1, false)
		};
		currentState = states['still'];
		type = 'Pot';
...
class PotIx extends Shrine
{
	PotIx(String id, int x, int y) : super(id,x,y)
	{
		states =
		{
			"close" : new Spritesheet("close","http://c2.glitch.bz/items/2012-12-06/npc_shrine_ix_pot__x1_close_png_1354831299.png",840,864,168,216,20, false),
			"open" : new Spritesheet("open","http://c2.glitch.bz/items/2012-12-06/npc_shrine_ix_pot__x1_open_png_1354831298.png",840,1080,168,216,24, false),
			"still" : new Spritesheet("still","http://c2.glitch.bz/items/2012-12-06/npc_shrine_ix_pot__x1_open_png_1354831298.png",840,1080,168,216, 1, false)
		};
		currentState = states['still'];
		type = 'Pot';
