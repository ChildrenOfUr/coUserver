...
class FriendlyFirebog extends Shrine
{
	FriendlyFirebog(String id, int x, int y) : super(id,x,y)
	{
		states =
		{
			"close" : new Spritesheet("close","http://c2.glitch.bz/items/2012-12-06/npc_shrine_firebog_friendly__x1_close_png_1354832801.png",984,848,164,212,23,false),
			"open" : new Spritesheet("open","http://c2.glitch.bz/items/2012-12-06/npc_shrine_firebog_friendly__x1_open_png_1354832798.png",984,848,164,212,22,false),
			"still" : new Spritesheet("still","http://c2.glitch.bz/items/2012-12-06/npc_shrine_firebog_friendly__x1_open_png_1354832798.png",984,848,164,212,1,false)
		};
		currentState = states['still'];
		type = 'Friendly';
...
class FriendlyUralia extends Shrine
{
	FriendlyUralia(String id, int x, int y) : super(id,x,y)
	{
		states =
		{
			"close" : new Spritesheet("close","http://c2.glitch.bz/items/2012-12-06/npc_shrine_uralia_friendly__x1_close_png_1354831876.png",756,752,126,188,23,false),
			"open" : new Spritesheet("open","http://c2.glitch.bz/items/2012-12-06/npc_shrine_uralia_friendly__x1_open_png_1354831874.png",756,752,126,188,22,false),
			"still" : new Spritesheet("still","http://c2.glitch.bz/items/2012-12-06/npc_shrine_uralia_friendly__x1_open_png_1354831874.png",756,752,126,188,1,false)
		};
		currentState = states['still'];
		type = 'Friendly';
