...
class Mailbox extends NPC {
	Mailbox(String id, int x, int y) : super(id, x, y) {
		...
		states = {
			"add_done":new Spritesheet("all_done", 'http://childrenofur.com/assets/entityImages/npc_mailbox_variant_mailboxLeft_x1_all_done_png_1354832237.png', 776, 438, 97, 146, 22, false),
			"has_mail":new Spritesheet("has_mail", 'http://childrenofur.com/assets/entityImages/npc_mailbox_variant_mailboxLeft_x1_has_mail_png_1354832234.png', 970, 1168, 97, 146, 73, true),
			"interract":new Spritesheet("interract", 'http://childrenofur.com/assets/entityImages/npc_mailbox_variant_mailboxLeft_x1_interact_png_1354832236.png', 873, 146, 97, 146, 9, false),
			"idle":new Spritesheet("idle", 'http://childrenofur.com/assets/entityImages/npc_mailbox_variant_mailboxLeft_x1_idle_png_1354832232.png', 97, 146, 97, 146, 1, false),
			"has_mail_idle":new Spritesheet("has_mail_idle", 'http://childrenofur.com/assets/entityImages/npc_mailbox_variant_mailboxLeft_x1_has_mail_idle_png_1354832235.png', 97, 146, 97, 146, 1, false)
		};
