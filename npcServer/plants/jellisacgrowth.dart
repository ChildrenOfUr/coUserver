...
class Jellisac extends Plant {
	Jellisac(String id, int x, int y) : super(id, x, y) {
		...
		states = {
			"1-2-3-4-5" : new Spritesheet("1-2-3-4-5", "http://childrenofur.com/assets/game/jellisac_growth/jellisac_growth_1.png", 210, 49, 42, 49, 5, false),
		};
	...
	Future<bool> grab({WebSocket userSocket, String email}) async {
		...
		addItemToUser(userSocket, email, items['jellisac'].getMap(), numToGive, id);
