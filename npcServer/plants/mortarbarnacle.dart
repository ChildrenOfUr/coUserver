...
class MortarBarnacle extends Plant {
	MortarBarnacle(String id, int x, int y) : super(id, x, y) {
		...
		states = {
			"1-2-3-4-5" : new Spritesheet("1-2-3-4-5", "http://childrenofur.com/assets/game/mortar_barnacle/facingleft.png", 300, 70, 60, 70, 5, false),
		};
	...
	Future<bool> scrape({WebSocket userSocket, String email}) async {
		...
		addItemToUser(userSocket, email, items['barnacle'].getMap(), numToGive, id);
