		...
		if (streetName.toLowerCase().contains("machine room")) {
			switch (streetName) {
				case "Besara Community Machine Room":
					toLocation = "LA9G6MA4P6923PH"; // Canary Send
					break;

				case "Forest Community Machine Room":
					toLocation = "LLI23FELDHD1O3C"; // Middle Valley Clearing
					break;

				case "Meadow Community Machine Room":
					toLocation = "LCR10K3BPJK1U6F"; // Otterlane
					break;
			}
			outside = false;
			...
			switch (streetName) {
				case "Canary Send":
					toLocation = "LA9MU59GB792T80"; // Besara Community Machine Room
					break;

				case "Middle Valley Clearing":
					toLocation = "LIF16EM56A12FSB"; // Forest Community Machine Room
					break;

				case "Otterlane":
					toLocation = "LCR101Q98A12EHH"; // Meadow Community Machine Room
					break;
			}
			outside = true;
